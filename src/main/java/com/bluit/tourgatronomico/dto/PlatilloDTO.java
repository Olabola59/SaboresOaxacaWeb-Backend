...
public class PlatilloDTO {
    ...
    // 👇 ingredientes (te llega como lista desde el request y se construye desde el modelo)
    private List<String> ingredientes;

    // ✅ NUEVO: ids de palabras clave seleccionadas (para guardar en platillos_palabras_clave)
    private List<Long> palabraIds;
    ...
    public PlatilloDTO(Platillo platillo) {
        ...
        // ingredientes en tu entidad parece ser String[] (por eso haces Arrays.asList)
        this.ingredientes = (platillo.getIngredientes() == null)
                ? List.of()
                : Arrays.asList(platillo.getIngredientes());
    ...
    // ✅ NUEVO
    public List<Long> getPalabraIds() { return palabraIds; }
    public void setPalabraIds(List<Long> palabraIds) { this.palabraIds = palabraIds; }
